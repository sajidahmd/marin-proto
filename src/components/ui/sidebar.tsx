...
>(
  (
    ...
    const Comp = asChild ? Slot : (isSubTrigger ? CollapsiblePrimitive.Trigger : "button");
...
>(({ className, ...props }, ref) => (
  <ul
    ref={ref}
    data-sidebar="menu-sub-nav-list"
    className={cn(
...
SidebarMenuSubNavList.displayName = "SidebarMenuSubNavList"
